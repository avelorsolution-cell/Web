(function () {
  var translations = {
    ...
    "home.svc.maint.desc": {en:"Flexible technical support, updates and improvements to keep your website performing properly.", ar:"دعم تقني مرن وتحديثات وتحسينات للمحافظة على أداء موقعك بشكل سليم."},
    ...
    "home.svc.marketing.desc": {en:"Digital content, campaign creative and practical marketing support to strengthen your online presence.", ar:"محتوى رقمي وتصاميم للحملات ودعم تسويقي عملي لتعزيز حضورك على الإنترنت."},
    ...
    "home.why.3.title": {en:"Structured Delivery", ar:"تسليم منظم"},
    "home.why.3.desc": {en:"Clear milestones and an organised workflow keep projects moving efficiently.", ar:"مراحل واضحة وسير عمل منظم يساعدان على تقدم المشروع بكفاءة."},
    ...
    "home.why.5.title": {en:"Performance-Focused Build", ar:"بناء يركز على الأداء"},
    "home.why.5.desc": {en:"Modern, lightweight technology focused on speed, responsiveness and maintainability.", ar:"تقنيات حديثة وخفيفة تركز على السرعة والتجاوب وسهولة الصيانة."},
    ...
    "home.portfolio.eyebrow": {en:"Selected Creative Work", ar:"أعمال إبداعية مختارة"},
    "home.portfolio.title": {en:"Concepts that show how we think and create", ar:"نماذج تعكس أسلوبنا في التفكير والإبداع"},
    "home.portfolio.sub": {en:"Selected website, visualization and graphic design concepts created to demonstrate AVELOR\'s capabilities.", ar:"نماذج مختارة من تصميم المواقع والتصور ثلاثي الأبعاد والتصميم الجرافيكي لإظهار قدرات AVELOR."},
    "home.portfolio.card1.title": {en:"Premium Business Website", ar:"موقع أعمال احترافي"},
    "home.portfolio.card1.desc": {en:"Responsive company-profile website concept across desktop and mobile.", ar:"تصور لموقع تعريفي متجاوب للشركة على الكمبيوتر والجوال."},
    "home.portfolio.card2.title": {en:"Masjid Exterior Visualization", ar:"تصور خارجي لمسجد"},
    "home.portfolio.card2.desc": {en:"Architectural exterior visualization developed as a presentation concept.", ar:"تصور معماري خارجي تم تطويره كنموذج للعرض."},
    "home.portfolio.card3.title": {en:"Premium Brand Identity", ar:"هوية تجارية مميزة"},
    "home.portfolio.card3.desc": {en:"Logo, typography, colour and brand application system concept.", ar:"تصور متكامل للشعار والخطوط والألوان وتطبيقات الهوية."},
    "home.portfolio.card4.title": {en:"Product Catalogue Concept", ar:"تصور كتالوج منتجات"},
    "home.portfolio.card4.desc": {en:"Structured product catalogue layout designed for clear, premium presentation.", ar:"تصميم منظم لكتالوج منتجات يركز على العرض الواضح والاحترافي."},

    "home.process.eyebrow": {en:"How We Work", ar:"كيف نعمل"},
    "home.process.title": {en:"A clear process from idea to delivery", ar:"عملية واضحة من الفكرة حتى التسليم"},
    "home.process.1.title": {en:"Discover", ar:"الاكتشاف"},
    "home.process.1.desc": {en:"Understanding your goals, audience and project scope.", ar:"فهم أهدافك وجمهورك ونطاق المشروع."},
    "home.process.2.title": {en:"Plan", ar:"التخطيط"},
    "home.process.2.desc": {en:"Defining structure, content, deliverables and milestones.", ar:"تحديد الهيكل والمحتوى والمخرجات والمراحل الرئيسية."},
    "home.process.3.title": {en:"Create", ar:"الإنشاء"},
    "home.process.3.desc": {en:"Designing and building the approved creative direction.", ar:"تصميم وتنفيذ الاتجاه الإبداعي المعتمد."},
    "home.process.4.title": {en:"Launch", ar:"الإطلاق"},
    "home.process.4.desc": {en:"Testing carefully and preparing the final project for release.", ar:"اختبار المشروع بعناية وتجهيز النسخة النهائية للإطلاق."},
    "home.process.5.title": {en:"Support", ar:"الدعم"},
    "home.process.5.desc": {en:"Providing technical support and future improvements when required.", ar:"توفير الدعم الفني والتحسينات المستقبلية عند الحاجة."},
    ...
    "pf.hero.sub": {en:"Explore website, branding, graphic design, 3D visualization and technical concept work — then open any project for a closer look.", ar:"استكشف نماذج تصميم المواقع والهوية التجارية والتصميم الجرافيكي والتصور ثلاثي الأبعاد والأعمال الفنية، ثم افتح أي مشروع للاطلاع على التفاصيل."},
    "pf.disclaimer": {en:"All portfolio items shown here are self-initiated concept projects unless clearly stated otherwise. They demonstrate AVELOR’s design process and creative capabilities and are not presented as commissioned client work.", ar:"جميع الأعمال المعروضة هنا مشاريع تصورية ذاتية من AVELOR ما لم يُذكر خلاف ذلك بوضوح. تم إعدادها لعرض أسلوب التصميم والقدرات الإبداعية، ولا يتم تقديمها على أنها أعمال منفذة بتكليف من عملاء."},
    ...
    "pf.card8.title": {en:"Boutique Cafe — Pastry Display", ar:"مقهى بوتيكي — منطقة عرض الحلويات"},
    "pf.card8.desc": {en:"Interior visualization focused on a premium pastry display zone.", ar:"تصور داخلي يركز على منطقة عرض حلويات بطابع مميز."},
    "pf.card9.title": {en:"Boutique Cafe — Main Interior", ar:"مقهى بوتيكي — التصميم الداخلي الرئيسي"},
    "pf.card9.desc": {en:"Full interior concept balancing warm materials, seating and product display.", ar:"تصور داخلي متكامل يوازن بين الخامات الدافئة والجلوس وعرض المنتجات."},
    "pf.card10.title": {en:"Boutique Cafe — Evening Lighting", ar:"مقهى بوتيكي — إضاءة مسائية"},
    "pf.card10.desc": {en:"Evening lighting variant of the cafe interior render.", ar:"نسخة إضاءة مسائية لتصور المقهى الداخلي."},
    "pf.card11.title": {en:"Lighting Product Catalogue Concept", ar:"تصور كتالوج منتجات إضاءة"},
    "pf.card11.desc": {en:"Structured catalogue layout for clear technical and product presentation.", ar:"تصميم منظم لكتالوج يركز على عرض المنتجات والمعلومات الفنية بوضوح."},
    "pf.card12.title": {en:"New Year Lighting Campaign Concept", ar:"تصور حملة رأس السنة لمنتجات الإضاءة"},
    "pf.card12.desc": {en:"Seasonal campaign artwork built around a premium lighting product.", ar:"تصميم حملة موسمية مبني حول منتج إضاءة بطابع مميز."},
    "pf.card13.title": {en:"Lighting Products Website Concept", ar:"تصور موقع لمنتجات الإضاءة"},
    "pf.card13.desc": {en:"Product-focused web interface with clear categories and premium visual hierarchy.", ar:"واجهة موقع تركز على المنتجات مع تصنيفات واضحة وتسلسل بصري احترافي."},
    "pf.card14.title": {en:"Premium Lighting Company Website", ar:"موقع شركة إضاءة احترافي"},
    "pf.card14.desc": {en:"Corporate website concept combining company information, products and enquiries.", ar:"تصور لموقع شركة يجمع بين المعلومات التعريفية والمنتجات وطلبات التواصل."},


    "pf.card15.title": {en:"Doha Property Landing Page", ar:"صفحة هبوط عقارية في الدوحة"},
    "pf.card15.desc": {en:"Conversion-focused real estate landing page with property highlights and enquiry flow.", ar:"صفحة عقارية تركز على التحويل مع إبراز العقارات ومسار واضح للاستفسار."},
    "pf.card16.title": {en:"Medical Clinic Website Concept", ar:"تصور موقع لعيادة طبية"},
    "pf.card16.desc": {en:"Calm, accessible clinic website with services and appointment-focused layout.", ar:"موقع عيادة بتصميم هادئ وسهل الاستخدام يركز على الخدمات وحجز المواعيد."},
    "pf.card17.title": {en:"Boutique Hotel Website Concept", ar:"تصور موقع لفندق بوتيكي"},
    "pf.card17.desc": {en:"Hospitality website concept with immersive rooms, amenities and booking direction.", ar:"تصور لموقع ضيافة يبرز الغرف والمرافق ويوجه الزائر نحو الحجز."},
    "pf.card18.title": {en:"Construction Company Website", ar:"موقع شركة مقاولات"},
    "pf.card18.desc": {en:"Bold corporate website concept for construction, project capability and enquiries.", ar:"تصور موقع مؤسسي قوي لشركة مقاولات يعرض القدرات والمشاريع والاستفسارات."},
    "pf.card19.title": {en:"Premium Brand Identity System", ar:"نظام هوية تجارية مميز"},
    "pf.card19.desc": {en:"Logo direction, typography, colour system and branded applications as one identity concept.", ar:"اتجاه للشعار والخطوط ونظام الألوان وتطبيقات الهوية ضمن تصور متكامل."},
    "pf.card20.title": {en:"Social Media Campaign Kit", ar:"حزمة حملة للتواصل الاجتماعي"},
    "pf.card20.desc": {en:"Coordinated social media artwork designed for a consistent campaign launch.", ar:"تصاميم متناسقة لوسائل التواصل الاجتماعي مخصصة لإطلاق حملة موحدة."},
    "pf.card21.title": {en:"Corporate Profile Brochure", ar:"بروشور الملف التعريفي للشركة"},
    "pf.card21.desc": {en:"Editorial company-profile concept for presenting services, capabilities and contact details.", ar:"تصور تحريري لملف شركة يعرض الخدمات والقدرات ومعلومات التواصل."},
    "pf.card22.title": {en:"AVELOR AI Demo Experience", ar:"تجربة AVELOR AI للموقع التجريبي"},
    "pf.card22.desc": {en:"Interactive website-demo experience that turns business details into a visual concept.", ar:"تجربة تفاعلية تحول بيانات النشاط التجاري إلى تصور بصري لموقع إلكتروني."},
    "pf.card23.title": {en:"Restaurant Brand Identity Concept", ar:"تصور هوية تجارية لمطعم"},
    "pf.card23.desc": {en:"Warm hospitality identity explored across logo, menu and social applications.", ar:"هوية ضيافة دافئة مطبقة على الشعار والقائمة وتصاميم التواصل الاجتماعي."},
    "pf.card24.title": {en:"Luxury Property Brand Identity", ar:"هوية تجارية لعقار فاخر"},
    "pf.card24.desc": {en:"Refined property-brand concept built around architectural forms and premium presentation.", ar:"تصور هوية عقارية راقية مستوحاة من الأشكال المعمارية والعرض المميز."},

    "pf.card25.title": {en:"Product Identification System & Admin Panel", ar:"نظام تعريف المنتجات ولوحة الإدارة"},
    "pf.card25.desc": {en:"Internal product catalogue system with advanced search, filtering and an admin panel designed to manage 10,000+ items.", ar:"نظام داخلي لكتالوج المنتجات مع بحث وتصفية متقدمة ولوحة إدارة مصممة لإدارة أكثر من 10,000 منتج."},
